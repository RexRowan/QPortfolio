...
- [Repository](https://github.com/RexRowan/Qiskit-ZX-Verified){target="_blank"}
- - [Qiskit Ecosystem listing](https://qiskit.github.io/ecosystem/p/91f8bc77/){target="_blank"} — classified `Tooling`, , labeled `quantum information`, `reaserch`
