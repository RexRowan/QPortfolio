...
- [Repository](https://github.com/RexRowan/Qiskit-Quantum-Backend-Selector){target="_blank"}
- [Qiskit Ecosystem listing](https://qiskit.github.io/ecosystem/p/91a8267e/){target="_blank"} — classified `Tooling`, labeled `cloud service`, `utility-scale`, `benchmarking`
- [PyPI](https://pypi.org/project/qiskit-quantum-backend-selector/){target="_blank"}
